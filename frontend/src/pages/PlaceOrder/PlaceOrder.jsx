...
const PlaceOrder = () => {
  ...
  const getConditionalDeliveryCharge = () => {
    ...
    const variants = ["hayatabad", "hyatabad", "haytabad"]; // allow common spellings/typos
    const isFree = variants.some((v) => city.includes(v));
    return isFree ? 0 : 200;
  };
  ...
  const placeOrder = async (e) => {
    ...
    let response = await axios.post(url + "/api/order/place", formData, {
      headers: { token },
    ...
    async function checkOpenStatus() {
      ...
      if (hours) {
        ...
        const opening = moment.tz(
          hours.openingHour,
          "HH:mm",
          hours.timezone || "Asia/Karachi"
        );
        let closing = moment.tz(
          hours.closingHour,
          "HH:mm",
          hours.timezone || "Asia/Karachi"
        );
  ...
  return (
    <>
      {!isOpen && (
        ...
        >
          We are currently closed. Please come back at{" "}
          {restaurantHours
            ? moment(restaurantHours.openingHour, "HH:mm").format("h:mma")
            : "10:00am"}
          !
        </div>
      )}
          ...
          {orderType === "delivery" && (
            <>
              <input
                ...
                onChange={onChangeHandler}
                value={data.street}
                placeholder="Street/Full Adress"
                required
              />
              <input
                type="text"
        ...
        <div className="place-order-right">
          ...
          <div className="payment">
            ...
            >
              ...
              />
              <label>EasyPaisa (Online Transfer)</label>
            </div>
            <div
            ...
            >
              ...
              />
              <label>JazzCash (Online Transfer)</label>
            </div>
            ...
            {payment !== "cod" && (
              ...
              >
                <p style={{ marginBottom: 8 }}>
                  <b>Instructions:</b> Please transfer the total amount to the
                  following account and upload a screenshot of your payment.
                  Enter your transaction ID as well.
                </p>
                <ul style={{ marginBottom: 8 }}>
                  {payment === "easypaisa" && (
                    <li>
                      EasyPaisa Number: <b>03xx-xxxxxxx</b>
                    </li>
                  )}
                  {payment === "jazzcash" && (
                    <li>
                      JazzCash Number: <b>03xx-xxxxxxx</b>
                    </li>
                  )}
                  {payment === "bank" && (
                    <li>
                      Bank Account: <b>1234567890 (Bank Name)</b>
                    </li>
                  )}
                </ul>
                <input
