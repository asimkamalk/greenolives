...
const Cart = () => {
  ...
  const {cartItems, food_list, removeFromCart,getTotalCartAmount,url,currency, setCartItemQuantity, restaurantHours, fetchRestaurantHours} = useContext(StoreContext);
